  ...
  ko: {
    ...
    sections: [
      ...
      },
      {
        title: '반품 배송비',
        items: [
          '- 단순 변심·사이즈 교환: 왕복 배송비 7,000원 고객 부담 (출고비 3,500원 + 회수비 3,500원)',
          '- 무료배송(80,000원 이상) 주문도 동일하게 적용됩니다 (출고 시 발생한 배송비를 포함).',
          '- 반품 배송비는 환불 금액에서 차감됩니다.',
          '- 상품 불량·오배송: 반품 배송비 회사 부담 (전액 환불).',
        ],
      },
      {
        title: '배송비 정책',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '- お客様都合・サイズ交換の返品：往復送料7,000ウォンお客様負担（発送料3,500＋返送料3,500）',
          '- 送料無料（80,000ウォン以上）のご注文も同様に適用されます（発送時に発生した送料を含む）。',
          '- 返送料は返金額から差し引かれます。',
          '- 商品不良・誤送の場合：返送料は当社負担（全額返金）。',
        ],
      },
      {
        title: '返金処理',
