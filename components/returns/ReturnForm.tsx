...
const t = {
  ko: {
    ...
    errors: {
      ...
      RETURN_EXISTS: '이미 반품 신청이 접수된 주문입니다. 문의사항은 고객센터로 연락해 주세요.',
  ...
  ja: {
    ...
    errors: {
      ...
      RETURN_EXISTS: 'すでに返品申請が受付済みです。お問い合わせはカスタマーサポートまでご連絡ください。',
  ...
  en: {
    ...
    orderNumberPlaceholder: 'Numbers only  e.g. 1001',
    customerNamePlaceholder: 'Name used when placing the order',
    ...
    exchangeNotice: 'If you need a size exchange, please return the item first and place a new order once your refund is confirmed.',
    ...
    refundAccountCheck: 'Did you pay by bank transfer?',
    ...
    errors: {
      ...
      NAME_MISMATCH: 'The name does not match the order.',
      NOT_FULFILLED: 'This order has not shipped yet. Please contact us if you wish to cancel.',
      RETURN_EXISTS: 'A return request for this order has already been submitted. Please contact customer support.',
