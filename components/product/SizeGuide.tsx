...
const bodySizes = [
  { label: 'XS',  age: { ko: '1~2세', ja: '1~2歳' }, standard: '80호',  height: '80cm',  weight: '11kg' },
  { label: 'S',   age: { ko: '2~3세', ja: '2~3歳' }, standard: '85호',  height: '85cm',  weight: '12kg' },
  { label: 'M',   age: { ko: '3~4세', ja: '3~4歳' }, standard: '90호',  height: '90cm',  weight: '13kg' },
  { label: 'L',   age: { ko: '4~5세', ja: '4~5歳' }, standard: '100호', height: '100cm', weight: '16kg' },
  { label: 'XL',  age: { ko: '5~6세', ja: '5~6歳' }, standard: '110호', height: '110cm', weight: '20kg' },
  { label: '2XL', age: { ko: '6~7세', ja: '6~7歳' }, standard: '120호', height: '120cm', weight: '22kg' },
  { label: '3XL', age: { ko: '7~8세', ja: '7~8歳' }, standard: '130호', height: '130cm', weight: '25kg' },
]
